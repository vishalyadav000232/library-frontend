...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-amber-900 to-amber-950 text-amber-50 pt-12 pb-20 md:pb-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-amber-300">Your Reading Haven</p>
              </div>
            </div>
            <p className="text-amber-200 text-sm mb-4">
              A premium library and study space designed for students and book
              lovers. Experience comfort, knowledge, and productivity in one
              place.
            </p>
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 bg-amber-800 hover:bg-amber-700 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110"
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <Link
                    to={link.path}
                    className="text-amber-200 hover:text-amber-50 text-sm transition-colors duration-200 hover:translate-x-1 inline-block"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-amber-200 text-sm hover:text-amber-50 transition-colors"
                >
                  +91 98765 43210
                </a>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="text-amber-200 text-sm">
                  <p>Mon - Sun</p>
                  <p className="text-amber-300">6:00 AM - 11:00 PM</p>
                </div>
              </li>
            </ul>
          </div>
